    ...
    def account_checker(self, user_accounts, proxy_pool):
        for token in user_accounts:
            ...
            if account_status == 401:
                print(
                    Fore.YELLOW
                    + "[{}] Writing Banned Token {}".format(str(datetime.now()), token)
                )
                ...
                print(
                    Fore.GREEN
                    + "[{}] Writing Verified Token {}".format(
                        str(datetime.now()), token
                    )
                )
                ...
                print(
                    Fore.RED
                    + "[{}] Unable To Check Token {}".format(str(datetime.now()), token)
                )
